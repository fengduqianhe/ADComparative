...
if __name__ == "__main__":
    ...
    val_data_path1 = '/adni2_ad_nc_val_label.csv'
    val_data_path2 = '/adni2_ad_nc_val_label_shuffle.csv'

    train_img_path = '/ad_nc/train/'
    val_img_path = '/ad_nc_regsiter/'
    ...
    for epoch in range(epochs):
        ...
        for i, data in tqdm(enumerate(train_loader), total=len(train_loader)):
            ...
            loss_contrastive = criterion(logps_s, labels3)
            print("loss_contrastive", loss_contrastive)

            loss = 0.5 * loss_group + 0.5 * loss_contrastive
            print("loss", loss)
        ...
        with torch.no_grad():
            ...
            result.to_csv("group_compair.csv", mode='w', index=False,
                          header=True)
